...
//     // New function to process all tehsils automatically
...
//             message: `Starting automatic processing of all Tehsils`
//         });
...
//             if (!isProcessingAllTehsils) break; // Allow cancellation
...
//             // Process all villages for this tehsil
//             if (villages.length > 0) {
//                 await startAutoProcessing(tehsil, villages, true);
//             } else {
//                 addLogEntry({
//                     type: 'system',
//                     action: 'no_villages',
...
const TehsilMohallaDashboardOld = () => {
    const navigate = useNavigate();
    // State for storing tehsils and their villages
    const [tehsils, setTehsils] = useState([]);
    const [selectedTehsil, setSelectedTehsil] = useState(null);
    ...
    const [requestHistory, setRequestHistory] = useState([]);
    const [showHistory, setShowHistory] = useState(true);
    const [isProcessingBatch, setIsProcessingBatch] = useState(true);
    const [processingStats, setProcessingStats] = useState({
        total: 0,
        completed: 0,
        success: 0,
